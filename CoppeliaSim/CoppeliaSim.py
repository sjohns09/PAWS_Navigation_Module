'''
Code from Coppelia Sim that is needed in the package
in order to use the simulation's Remote API.
'''
...
import os
import ctypes as ct
from PAWS_Bot_Navigation.CoppeliaSim.CoppeliaSimConst import *
